...
export default function Home({ onStartExam, onReadConcept }) {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      {/* Header / Hero */}
      <div className="bg-gradient-to-br from-indigo-900 via-slate-900 to-slate-950 rounded-2xl p-8 mb-8 text-white shadow-2xl border border-slate-800 text-center md:text-left md:flex items-center justify-between">
        <div className="mb-6 md:mb-0 md:max-w-xl">
          <div className="flex items-center justify-center md:justify-start gap-2 mb-3">
            ...
            <span className="text-slate-400 text-xs font-medium">Dark Mode Sandbox</span>
          </div>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        {/* Practice Exam Setup */}
        <div className="bg-slate-900 rounded-xl shadow-xl border border-slate-800 p-6 flex flex-col justify-between">
          <div>
            <div className="flex items-center gap-3 mb-6 border-b border-slate-800 pb-3">
              ...
              <h2 className="text-xl font-bold text-slate-100">Configure Practice Exam</h2>
            </div>
            ...
            <form onSubmit={handleStartExamSubmit} className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full bg-slate-950 border border-slate-700 rounded-lg px-3 py-2.5 text-slate-200 focus:outline-none focus:ring-2 focus:ring-amber-500 font-medium transition"
                >
              ...
              <div>
                ...
                {availableCount > 0 ? (
                  ...
                  <div className="bg-rose-950/30 border border-rose-900/50 text-rose-400 text-sm p-3 rounded-lg flex items-start gap-2">
        ...
        <div className="bg-slate-900 rounded-xl shadow-xl border border-slate-800 p-6 flex flex-col justify-between">
          <div>
            <div className="flex items-center gap-3 mb-6 border-b border-slate-800 pb-3">
              ...
              <h2 className="text-xl font-bold text-slate-100">Read Concepts</h2>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full bg-slate-950 border border-slate-700 rounded-lg px-3 py-2.5 text-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 font-medium transition"
                >
                  {certifications.map(cert => (
                    <option key={cert} value={cert}>{cert}</option>
                  ))}
              ...
              <div>
                ...
                {availableConceptsForReading.length > 0 ? (
                  ...
                  <div className="bg-slate-950 border border-slate-800 text-slate-500 text-xs p-3 rounded-lg italic">
              ...
              <button
                ...
                className="w-full mt-6 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold px-6 py-3 rounded-lg transition duration-200 shadow-lg shadow-indigo-500/10 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                <BookOpen size={18} />
          ...
          <div className="mt-8 border-t border-slate-800 pt-6">
            <h3 className="text-sm font-semibold text-slate-400 mb-2">Adding Daily Questions?</h3>
      ...
      <div className="mt-12 flex justify-center border-t border-slate-900 pt-8">
        {!showConfirmReset ? (
          <button
            ...
            className="text-xs font-semibold text-slate-600 hover:text-rose-500 flex items-center gap-1.5 px-3 py-1.5 rounded-md hover:bg-slate-900 transition"
          >
            <RotateCcw size={14} />
            Reset All Saved App Data
          </button>
        ) : (
          <div className="bg-rose-950/20 border border-rose-900/50 p-6 rounded-xl max-w-md text-center shadow-2xl">
            <div className="flex justify-center mb-3">
              <AlertTriangle className="text-rose-500" size={28} />
            </div>
            <p className="text-sm font-bold text-rose-200 mb-4 leading-relaxed">
              Are you sure you want to clear all saved exam data? This will wipe all progress.
            </p>
            <div className="flex gap-3 justify-center">
              <button
                onClick={handleResetAllData}
                className="bg-rose-600 hover:bg-rose-700 text-white text-xs font-bold px-5 py-2.5 rounded-lg shadow-md transition"
              >
                Yes, Clear Everything
              </button>
              <button
                onClick={() => setShowConfirmReset(false)}
                className="bg-slate-800 hover:bg-slate-700 text-slate-300 text-xs font-bold px-5 py-2.5 rounded-lg transition"
              >
                Cancel
              </button>
            </div>
